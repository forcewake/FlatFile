...
namespace FluentFiles.Tests.Conversion
{
    public class Int16ConverterTests
    {
        ...
        {
            // Act.
            var actual = _converter.Parse(new FieldParsingContext(input, null, typeof(short)));
        ...
        {
            // Act.
            var actual = _converter.Format(new FieldFormattingContext(input, null, typeof(short)));
